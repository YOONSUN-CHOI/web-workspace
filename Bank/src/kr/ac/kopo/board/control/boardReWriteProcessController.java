...
public class boardReWriteProcessController implements Controller{

	@Override
	public String handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// TODO Auto-generated method stub
		System.out.println("boardReWriteProcessController 진입");
		...
		String str_no = multi.getParameter("no");
		String str_originno = multi.getParameter("originno");
		int no = Integer.parseInt(str_no);
		int originno = Integer.parseInt(str_originno);
		//System.out.println("originno"+str_originno);
		...
		//답글 등록 전 groupord 컬럼 값 +1 해주기
		dao.updategroupord(no);
