...
public class updateBoardProcessController implements Controller {
	...
	public String handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String no_str = multi.getParameter("no");
		int BoardNo = Integer.parseInt(no_str);
		...
		String url = request.getContextPath() + "/detail.do?no="+BoardNo;
		request.setAttribute("url", url);
		
		return "/jsp/board/boardUpdateProcess.jsp";
	}
