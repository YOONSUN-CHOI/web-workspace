...
<script type="text/javascript">
	...
	/* function checkExt(obj){  // 블랙리스트 방식
	...
	function checkExt(obj){
		//alert('확장자 체크');
		let allow_Name=['doc','hwp','pdf','xls','jpg','gif','png','txt','jpeg','pptx'];
		let fileName = obj.value;
		let searchIdx = fileName.lastIndexOf('.'); //인덱스 0부터 시작
		let ext = fileName.substring(searchIdx+1); // 파일의 확장자 = ext로 뽑아냄
		//alert(ext);
		...
		if(boole =='same'){
			...
			alert('업로드 가능한 확장자 : doc, hwp, pdf, xls, jpg, gif, png, jpeg, txt');
			return true;
		}
	}
					...
					<div class="row" style="height: 570px; border-color: fuchsia;">
						...
						<div align="center">
							<!-- 여기 고고자아 -->
									<h3>게시물 등록폼</h3>
		<br>
		<form action="<%=request.getContextPath()%>/writeProcess.do" method="post" onsubmit="return doWrite()" 
			...
			<table border="1" style="width:90%">
				...
				<tr>
					<th width="23%">내용</th>
					<td><textarea rows="4" cols="100" name="content" required></textarea></td>
				</tr>
				<tr>
					<th>첨부파일</th>
					<td>
